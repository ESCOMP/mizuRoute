MODULE globalData
  ...
  real(dp),           allocatable, public :: basinCC_trib(:)        ! HRU constituent array (g) for tributaries
  real(dp),           allocatable, public :: basinCC_main(:)        ! HRU constituent array (g) for mainstem
