MODULE globalData
  ...
  real(dp),           allocatable, public :: basinCC_trib(:)        ! HRU consituent array (g) for tributaries
  real(dp),           allocatable, public :: basinCC_main(:)        ! HRU consituent array (g) for mainstem
