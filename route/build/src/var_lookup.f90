MODULE var_lookup
 ...
 type, public  ::  iLook_RFLX
  ...
  integer(i4b)     :: KWfloodVolume     = integerMissing  ! 14. KW water volume in floodplain (m3)
  integer(i4b)     :: MCfloodVolume     = integerMissing  ! 15. MC water volume in floodplain (m3)
  integer(i4b)     :: DWfloodVolume     = integerMissing  ! 16. DW water volume in floodplain (m3)
  integer(i4b)     :: IRFinflow         = integerMissing  ! 17. IRF inflow from upstreams into reach/lake (m3/s)
  integer(i4b)     :: KWTinflow         = integerMissing  ! 18. KWT inflow flow upstreams into reach/lake (m3/s)
  integer(i4b)     :: KWinflow          = integerMissing  ! 19. KW inflow from upstreams into reach/lake (m3/s)
  integer(i4b)     :: MCinflow          = integerMissing  ! 20. MC inflow from upstreams into reach/lake (m3/s)
  integer(i4b)     :: DWinflow          = integerMissing  ! 21. DW inflow from upstreams into reach/lake (m3/s)
 endtype iLook_RFLX
 ! HRU fluxes
