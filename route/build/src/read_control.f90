...
CONTAINS
 ...
 do iLine=1,size(cLines)
   ...
   case('<varname_H06_D_Jan>'      ); meta_SEG    (ixSEG%H06_I_Jan       )%varName =trim(cData)   ! Hanasaki 2006; Average January   demand [m3/s]
   case('<varname_H06_D_Feb>'      ); meta_SEG    (ixSEG%H06_I_Feb       )%varName =trim(cData)   ! Hanasaki 2006; Average Februrary demand [m3/s]
   case('<varname_H06_D_Mar>'      ); meta_SEG    (ixSEG%H06_I_Mar       )%varName =trim(cData)   ! Hanasaki 2006; Average March     demand [m3/s]
   case('<varname_H06_D_Apr>'      ); meta_SEG    (ixSEG%H06_I_Apr       )%varName =trim(cData)   ! Hanasaki 2006; Average April     demand [m3/s]
   case('<varname_H06_D_May>'      ); meta_SEG    (ixSEG%H06_I_May       )%varName =trim(cData)   ! Hanasaki 2006; Average May       demand [m3/s]
   case('<varname_H06_D_Jun>'      ); meta_SEG    (ixSEG%H06_I_Jun       )%varName =trim(cData)   ! Hanasaki 2006; Average June      demand [m3/s]
   case('<varname_H06_D_Jul>'      ); meta_SEG    (ixSEG%H06_I_Jul       )%varName =trim(cData)   ! Hanasaki 2006; Average July      demand [m3/s]
   case('<varname_H06_D_Aug>'      ); meta_SEG    (ixSEG%H06_I_Aug       )%varName =trim(cData)   ! Hanasaki 2006; Average August    demand [m3/s]
   case('<varname_H06_D_Sep>'      ); meta_SEG    (ixSEG%H06_I_Sep       )%varName =trim(cData)   ! Hanasaki 2006; Average September demand [m3/s]
   case('<varname_H06_D_Oct>'      ); meta_SEG    (ixSEG%H06_I_Oct       )%varName =trim(cData)   ! Hanasaki 2006; Average October   demand [m3/s]
   case('<varname_H06_D_Nov>'      ); meta_SEG    (ixSEG%H06_I_Nov       )%varName =trim(cData)   ! Hanasaki 2006; Average November  demand [m3/s]
   case('<varname_H06_D_Dec>'      ); meta_SEG    (ixSEG%H06_I_Dec       )%varName =trim(cData)   ! Hanasaki 2006; Average December  demand [m3/s]
