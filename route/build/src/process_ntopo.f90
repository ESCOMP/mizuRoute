...
contains
 ...
 subroutine put_data_struct(nSeg, structSEG, structNTOPO, &
  ...
  do iSeg=1,nSeg
   ...
   RPARAM_in(iSeg)%H06realP5       =     structSEG(iSeg)%var(ixSEG%H06realP5)%dat(1)
   RPARAM_in(iSeg)%H06realP6       =     structSEG(iSeg)%var(ixSEG%H06realP6)%dat(1)
   RPARAM_in(iSeg)%H06realP7       =     structSEG(iSeg)%var(ixSEG%H06realP7)%dat(1)
   RPARAM_in(iSeg)%H06realP8       =     structSEG(iSeg)%var(ixSEG%H06realP8)%dat(1)
   RPARAM_in(iSeg)%H06realP9       =     structSEG(iSeg)%var(ixSEG%H06realP9)%dat(1)
   RPARAM_in(iSeg)%H06realP10      =     structSEG(iSeg)%var(ixSEG%H06realP10)%dat(1)
   RPARAM_in(iSeg)%H06realP11      =     structSEG(iSeg)%var(ixSEG%H06realP11)%dat(1)
   RPARAM_in(iSeg)%H06realP12      =     structSEG(iSeg)%var(ixSEG%H06realP12)%dat(1)
   RPARAM_in(iSeg)%H06realP13      =     structSEG(iSeg)%var(ixSEG%H06realP13)%dat(1)
   RPARAM_in(iSeg)%H06realP14      =     structSEG(iSeg)%var(ixSEG%H06realP14)%dat(1)
   RPARAM_in(iSeg)%H06realP15      =     structSEG(iSeg)%var(ixSEG%H06realP15)%dat(1)
   RPARAM_in(iSeg)%H06realP16      =     structSEG(iSeg)%var(ixSEG%H06realP16)%dat(1)
   RPARAM_in(iSeg)%H06realP17      =     structSEG(iSeg)%var(ixSEG%H06realP17)%dat(1)
   RPARAM_in(iSeg)%H06realP18      =     structSEG(iSeg)%var(ixSEG%H06realP18)%dat(1)
   RPARAM_in(iSeg)%H06realP19      =     structSEG(iSeg)%var(ixSEG%H06realP19)%dat(1)
   RPARAM_in(iSeg)%H06realP20      =     structSEG(iSeg)%var(ixSEG%H06realP20)%dat(1)
   RPARAM_in(iSeg)%H06realP21      =     structSEG(iSeg)%var(ixSEG%H06realP21)%dat(1)
   RPARAM_in(iSeg)%H06realP22      =     structSEG(iSeg)%var(ixSEG%H06realP22)%dat(1)
   RPARAM_in(iSeg)%H06realP23      =     structSEG(iSeg)%var(ixSEG%H06realP23)%dat(1)
   RPARAM_in(iSeg)%H06realP24      =     structSEG(iSeg)%var(ixSEG%H06realP24)%dat(1)
   RPARAM_in(iSeg)%H06realP25      =     structSEG(iSeg)%var(ixSEG%H06realP25)%dat(1)
   RPARAM_in(iSeg)%H06realP26      =     structSEG(iSeg)%var(ixSEG%H06realP26)%dat(1)
   RPARAM_in(iSeg)%H06realP27      =     structSEG(iSeg)%var(ixSEG%H06realP27)%dat(1)
   RPARAM_in(iSeg)%H06realP28      =     structSEG(iSeg)%var(ixSEG%H06realP28)%dat(1)
   RPARAM_in(iSeg)%H06realP29      =     structSEG(iSeg)%var(ixSEG%H06realP29)%dat(1)
   RPARAM_in(iSeg)%H06realP30      =     structSEG(iSeg)%var(ixSEG%H06realP30)%dat(1)
   RPARAM_in(iSeg)%H06realP31      =     structSEG(iSeg)%var(ixSEG%H06realP31)%dat(1)
   RPARAM_in(iSeg)%H06realP32      =     structSEG(iSeg)%var(ixSEG%H06realP32)%dat(1)
   RPARAM_in(iSeg)%H06realP33      =     structSEG(iSeg)%var(ixSEG%H06realP33)%dat(1)
   RPARAM_in(iSeg)%H06realP34      =     structSEG(iSeg)%var(ixSEG%H06realP34)%dat(1)
   RPARAM_in(iSeg)%H06realP35      =     structSEG(iSeg)%var(ixSEG%H06realP35)%dat(1)
   RPARAM_in(iSeg)%H06realP36      =     structSEG(iSeg)%var(ixSEG%H06realP36)%dat(1)
   ...
   RPARAM_in(iSeg)%H06intP5        =     structSEG(iSeg)%var(ixSEG%H06intP5 )%dat(1)
   RPARAM_in(iSeg)%H06intP6        =     structSEG(iSeg)%var(ixSEG%H06intP6 )%dat(1)
