...
contains
 ...
 meta_SEG    (ixSEG%H06realP5        ) = var_info('H06realP5'      , 'Hanasaki 2006 P5 real'                             ,'-'     ,ixDims%seg   , .false.)
 meta_SEG    (ixSEG%H06realP6        ) = var_info('H06realP6'      , 'Hanasaki 2006 P6 real'                             ,'-'     ,ixDims%seg   , .false.)
 meta_SEG    (ixSEG%H06realP7        ) = var_info('H06realP7'      , 'Hanasaki 2006 P7 real'                             ,'-'     ,ixDims%seg   , .false.)
 meta_SEG    (ixSEG%H06realP8        ) = var_info('H06realP8'      , 'Hanasaki 2006 P8 real'                             ,'-'     ,ixDims%seg   , .false.)
 meta_SEG    (ixSEG%H06realP9        ) = var_info('H06realP9'      , 'Hanasaki 2006 P9 real'                             ,'-'     ,ixDims%seg   , .false.)
 meta_SEG    (ixSEG%H06realP10       ) = var_info('H06realP10'     , 'Hanasaki 2006 P10 real'                            ,'-'     ,ixDims%seg   , .false.)
 meta_SEG    (ixSEG%H06realP11       ) = var_info('H06realP11'     , 'Hanasaki 2006 P11 real'                            ,'-'     ,ixDims%seg   , .false.)
 meta_SEG    (ixSEG%H06realP12       ) = var_info('H06realP12'     , 'Hanasaki 2006 P12 real'                            ,'-'     ,ixDims%seg   , .false.)
 meta_SEG    (ixSEG%H06realP13       ) = var_info('H06realP13'     , 'Hanasaki 2006 P13 real'                            ,'-'     ,ixDims%seg   , .false.)
 meta_SEG    (ixSEG%H06realP14       ) = var_info('H06realP14'     , 'Hanasaki 2006 P14 real'                            ,'-'     ,ixDims%seg   , .false.)
 meta_SEG    (ixSEG%H06realP15       ) = var_info('H06realP15'     , 'Hanasaki 2006 P15 real'                            ,'-'     ,ixDims%seg   , .false.)
 meta_SEG    (ixSEG%H06realP16       ) = var_info('H06realP16'     , 'Hanasaki 2006 P16 real'                            ,'-'     ,ixDims%seg   , .false.)
 meta_SEG    (ixSEG%H06realP17       ) = var_info('H06realP17'     , 'Hanasaki 2006 P17 real'                            ,'-'     ,ixDims%seg   , .false.)
 meta_SEG    (ixSEG%H06realP18       ) = var_info('H06realP18'     , 'Hanasaki 2006 P18 real'                            ,'-'     ,ixDims%seg   , .false.)
 meta_SEG    (ixSEG%H06realP19       ) = var_info('H06realP19'     , 'Hanasaki 2006 P19 real'                            ,'-'     ,ixDims%seg   , .false.)
 meta_SEG    (ixSEG%H06realP20       ) = var_info('H06realP20'     , 'Hanasaki 2006 P20 real'                            ,'-'     ,ixDims%seg   , .false.)
 meta_SEG    (ixSEG%H06realP21       ) = var_info('H06realP21'     , 'Hanasaki 2006 P21 real'                            ,'-'     ,ixDims%seg   , .false.)
 meta_SEG    (ixSEG%H06realP22       ) = var_info('H06realP22'     , 'Hanasaki 2006 P22 real'                            ,'-'     ,ixDims%seg   , .false.)
 meta_SEG    (ixSEG%H06realP23       ) = var_info('H06realP23'     , 'Hanasaki 2006 P23 real'                            ,'-'     ,ixDims%seg   , .false.)
 meta_SEG    (ixSEG%H06realP24       ) = var_info('H06realP24'     , 'Hanasaki 2006 P24 real'                            ,'-'     ,ixDims%seg   , .false.)
 meta_SEG    (ixSEG%H06realP25       ) = var_info('H06realP25'     , 'Hanasaki 2006 P25 real'                            ,'-'     ,ixDims%seg   , .false.)
 meta_SEG    (ixSEG%H06realP26       ) = var_info('H06realP26'     , 'Hanasaki 2006 P26 real'                            ,'-'     ,ixDims%seg   , .false.)
 meta_SEG    (ixSEG%H06realP27       ) = var_info('H06realP27'     , 'Hanasaki 2006 P27 real'                            ,'-'     ,ixDims%seg   , .false.)
 meta_SEG    (ixSEG%H06realP28       ) = var_info('H06realP28'     , 'Hanasaki 2006 P28 real'                            ,'-'     ,ixDims%seg   , .false.)
 meta_SEG    (ixSEG%H06realP29       ) = var_info('H06realP29'     , 'Hanasaki 2006 P29 real'                            ,'-'     ,ixDims%seg   , .false.)
 meta_SEG    (ixSEG%H06realP30       ) = var_info('H06realP30'     , 'Hanasaki 2006 P30 real'                            ,'-'     ,ixDims%seg   , .false.)
 meta_SEG    (ixSEG%H06realP31       ) = var_info('H06realP31'     , 'Hanasaki 2006 P31 real'                            ,'-'     ,ixDims%seg   , .false.)
 meta_SEG    (ixSEG%H06realP32       ) = var_info('H06realP32'     , 'Hanasaki 2006 P32 real'                            ,'-'     ,ixDims%seg   , .false.)
 meta_SEG    (ixSEG%H06realP33       ) = var_info('H06realP33'     , 'Hanasaki 2006 P33 real'                            ,'-'     ,ixDims%seg   , .false.)
 meta_SEG    (ixSEG%H06realP34       ) = var_info('H06realP34'     , 'Hanasaki 2006 P34 real'                            ,'-'     ,ixDims%seg   , .false.)
 meta_SEG    (ixSEG%H06realP35       ) = var_info('H06realP35'     , 'Hanasaki 2006 P35 real'                            ,'-'     ,ixDims%seg   , .false.)
 meta_SEG    (ixSEG%H06realP36       ) = var_info('H06realP36'     , 'Hanasaki 2006 P36 real'                            ,'-'     ,ixDims%seg   , .false.)
 ...
 meta_SEG    (ixSEG%H06intP5         ) = var_info('H06intP5'       , 'Hanasaki 2006 P5 int'                              ,'-'     ,ixDims%seg   , .false.)
 meta_SEG    (ixSEG%H06intP6         ) = var_info('H06intP6'       , 'Hanasaki 2006 P6 int'                              ,'-'     ,ixDims%seg   , .false.)
